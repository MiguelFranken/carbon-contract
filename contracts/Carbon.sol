...
import "./CarbonWhitelistingLib.sol";
import "./CarbonLib.sol";

/**
 * Carbon is a decentralized generative art project where the rarity of the
 ...
 * previous minters at the time they minted their token. Carbon tokens
 ...
 * The total supply of Carbon is limited to 10000 unique tokens and each image
 * is stored decentralized on IPFS and Filecoin forever.
 */
contract Carbon is ERC721("Carbon", "CC"), ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    using OrderStatisticsTreeLib for OrderStatisticsTreeLib.Tree;
    using CarbonWhitelistingLib for CarbonWhitelistingLib.Whitelist;
    ...
    CarbonWhitelistingLib.Whitelist private whitelist;
     ...
     */
    function getListContract(uint8 lcId) external view returns (CarbonWhitelistingLib.ListContract memory lc) {
    ...
    {
        return string(abi.encodePacked(CarbonLib.getCid(tokenId), super.tokenURI(tokenId)));
    }
